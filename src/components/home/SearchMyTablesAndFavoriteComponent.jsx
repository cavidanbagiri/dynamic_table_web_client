...
function SearchMyTablesAndFavoriteComponent() {
    ...
    return (
        <div className='flex flex-row items-center justify-between mt-2 mb-4 w-full'>
            ...
            <input onChange={(e) => dispatch(searchMyTableAndFavoriteTable(e.target.value))} type="text" placeholder='Search' className='w-56 px-2 text-sm py-1 border border-gray-400 rounded-md outline-none' />
